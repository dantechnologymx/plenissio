                ...
                <div class="widget ">
                  ...
                  <div class="widget-content">
                    ...
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <input type="text" class="span3" name="Nombre_S" required="required" disabled="true" value="<?php echo utf8_decode($persona['nombre_s']) ;?>" />
                        <input type="hidden" name="Nombre_S" value="<?php echo utf8_decode($persona['nombre_s']) ;?>" />
                      </div> <!-- /controls -->       
                    </div> <!-- /control-group -->
                    ...
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <input type="text" class="span3" name="Apellido_Paterno" required="required" disabled="true" value="<?php echo utf8_decode($persona['apellido1']) ;?>" />
                        <input type="hidden" name="Apellido_Paterno" value="<?php echo utf8_decode($persona['apellido1']) ;?>" />
                      </div> <!-- /controls -->       
                    </div> <!-- /control-group -->
                    ...
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <input type="text" class="span3" name="Apellido_Materno" required="required" disabled="true" value="<?php echo utf8_decode($persona['apellido2']) ;?>" />
                        <input type="hidden" name="Apellido_Materno" value="<?php echo utf8_decode($persona['apellido2']) ;?>" />
                      </div> <!-- /controls -->       
                    </div> <!-- /control-group -->
                    ...
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <input type="text" class="span3" name="Estado" required="required" disabled="true" value="<?php echo $persona['estado']; ?>" />
                    ...
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <input type="text" class="span3" name="Fecha_Nacimiento" required="required" disabled="true" value="<?php echo $persona['fechaNacimiento'] ;?>" />
                        <input type="hidden" name="Fecha_Nacimiento" value="<?php $date = str_replace('/', '-', $persona['fechaNacimiento']); echo date("Y-m-d", strtotime($date));?>" />
                      </div> <!-- /controls -->       
                    </div> <!-- /control-group -->
                    ...
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <input type="text" class="span3" name="Nacionalidad" required="required" disabled="true" value="<?php echo "MEXICANA"; ?>" />
                        <input type="hidden" name="Nacionalidad" value="<?php echo "MEXICANA";?>" />
                      </div> <!-- /controls -->       
                    </div> <!-- /control-group -->
