  ...
  <div class="span12">          
    <div class="widget ">
      ...
      <div class="widget-content">
        <div class="row">
          <form class="form-horizontal" method="post" id="datos" action="<?php echo site_url('c_ventanilla/guardarDatos2');?>">
            <fieldset>
              <div class="span6"> 
                <div class="widget ">
                  <div class="widget-header">
                  ...
                  <div class="widget-content">
                    ...
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <input type="text" class="span3" name="Apellido_Paterno" required="required" disabled="true" value="<?php echo utf8_decode($persona->Apellido_Paterno) ;?>" />
                      </div> <!-- /controls -->       
                    </div> <!-- /control-group -->
                    ...
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <input type="text" class="span3" name="Apellido_Materno" required="required" disabled="true" value="<?php echo utf8_decode($persona->Apellido_Materno) ;?>" />
                      </div> <!-- /controls -->       
                    </div> <!-- /control-group -->
                    ...
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <input type="text" class="span3" name="Estado" required="required" disabled="true" value="<?php echo strtoupper($Estado[0]->Nombre); ?>" />
                      </div> <!-- /controls -->       
                    </div> <!-- /control-group -->
                    ...
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <input type="text" class="span3" name="Fecha_Nacimiento" required="required" disabled="true" value="<?php echo date_format(new DateTime($persona->Fecha_Nacimiento), 'd/m/Y') ;?>" />
                      </div> <!-- /controls -->       
                    </div> <!-- /control-group -->
                    ...
                    <div class="control-group">                     
                      ...
                      <div class="controls">
                        <input type="text" class="span3" name="Nacionalidad" required="required" disabled="true" value="<?php echo $persona->Nacionalidad; ;?>" />
                      </div> <!-- /controls -->       
                    </div> <!-- /control-group -->
...
<div id="fases" class="modal modal-lg hide fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: block;">
...
<script type="text/javascript">
  ...
  function guardar(e)
  {
    ...
    else
    {
      ...
      $.ajax({
        type : 'POST',
        url : "<?php echo site_url("C_ventanilla/guardarDatos2") ?>",
