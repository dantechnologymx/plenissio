				...
				<table id="example" class="table" cellspacing="0" width="100%">
	            	...
	            	<?php foreach ($servicios as $servicio) { ?>
                      ...
                      <td><?php echo $servicio->Fecha_Registro; ?></td>
			                ...
			                <td class="text-center"><a class = "btn btn-primary enc" href="<?php echo site_url().'/c_programasalimentarios/aplicaSV/'.$servicio->Id_Servicio_SV; ?>">Aplica <span class="icon-ok"></span> </a></td>
                			<td class="text-center"><a id="noaplicaSV" class = "btn btn-danger enc" href="#" data-toggle="modal" data-target="#modal_noprocede" onClick="modal(<?php echo $servicio->Id_Servicio_SV; ?>);" >No Procede <span class="icon-remove"></span> </a></td>
	              		</tr>
	              	<?php } ?>
	            	</tbody>
	          	</table>
...
<div id="modal_noprocede" class="modal hide fade" tabindex="-1" aria-labelledby="myModalLabel">
    ...
    <form method="post" id="datos" action="<?php echo site_url('c_programasalimentarios/noaplicaSV');?>">
        ...
        <div class="modal-footer">
        	<button type="button" class="btn btn-primary btn-large span3 offset1" id="guardar">Guardar &nbsp;</button>
        </div>
    </form>
</div>
...
<script type="text/javascript">
  ...
  function guardar(e)
  {
    ...
    $.ajax({
      type : 'POST',
      url : "<?php echo site_url().'/c_programasalimentarios/noaplicaSV/' ?>"+Id_Servicio_SV,
      data :$("#datos").serialize(),
      dataType: 'json',
      success : function(data) {
        console.log(data);
        window.location = "<?php echo site_url().'/c_programasalimentarios/sujetosVulnerablesIndexAB/';?>";
      },
