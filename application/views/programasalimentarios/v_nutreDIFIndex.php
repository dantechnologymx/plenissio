	...
	<div class="span12">      		
		<div class="widget ">
			<div class="widget-header">
				<i class="icon-user"></i>
				<h3><h3>Programas Alimentarios  <small>Padrón de Solicitudes Nuevas para Verificación</small></h3></h3>
			</div> <!-- /widget-header -->
			<div class="widget-content">

				<h4>Verifica cada caso segun el resultado de la Valoración Medica </h4>
				...
				<table id="example" class="table" cellspacing="0" width="100%">
	            	...
	            	<?php foreach ($servicios as $servicio) { ?>
                      ...
                      <td><?php echo $servicio->Fecha_Registro; ?></td>
			                ...
			                <td class="text-center"><a class = "btn btn-primary enc" href="<?php echo site_url().'/c_programasalimentarios/aplicaND/'.$servicio->Id_Servicio_ND; ?>">Procede <span class="icon-ok"></span> </a></td>
                			<td class="text-center"><a id="noaplicaND" class = "btn btn-danger enc" href="#" data-toggle="modal" data-target="#modal_noprocede" onClick="modal(<?php echo $servicio->Id_Servicio_ND; ?>);" >No Procede <span class="icon-remove"></span> </a></td>
	              		</tr>
	              	<?php } ?>
	            	</tbody>
	          	</table>
...
<div id="modal_noprocede" class="modal hide fade" tabindex="-1" aria-labelledby="myModalLabel">
    ...
    <form method="post" id="datos" action="<?php echo site_url('c_programasalimentarios/noaplicaND');?>">
...
<script type="text/javascript">
  ...
  function guardar(e)
  {
    ...
    $.ajax({
      type : 'POST',
      url : "<?php echo site_url().'/c_programasalimentarios/noaplicaND/' ?>"+Id_Servicio_ND,
