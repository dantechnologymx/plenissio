			...
			<div class="widget-content">
				...
				<table id="example" class="table" cellspacing="0" width="100%">
                    ...
                    <td><?php echo $servicio->Fecha_Registro; ?></td>
		                ...
		                <td class="text-center"><a id="removerPadronCB" class = "btn btn-danger enc" href="#" data-toggle="modal" data-target="#modal_noprocede" onClick="modal(<?php echo $servicio->Id_Servicio_CB; ?>);" >Quitar <span class="icon-remove"></span> </a></td>
		          		</tr>
		          	<?php } ?>
		        	</tbody>
		      	</table>
...
<div id="modal_noprocede" class="modal hide fade" tabindex="-1" aria-labelledby="myModalLabel">
    ...
    <form method="post" id="datos" action="<?php echo site_url('c_programasalimentarios/removerPadronCB');?>">
...
<script type="text/javascript">
  ...
  function guardar(e)
  {
    ...
    $.ajax({
      type : 'POST',
      url : "<?php echo site_url().'/c_programasalimentarios/removerPadronCB/' ?>"+Id_Servicio_CB,
      data :$("#datos").serialize(),
      dataType: 'json',
      success : function(data) {
        console.log(data);
        window.location = "<?php echo site_url().'/c_programasalimentarios/padronCB/';?>";
      },
