			...
			<div class="widget-content">
				...
				<table id="example" class="table" cellspacing="0" width="100%">
                    ...
                    <td><?php echo $servicio->Fecha_Registro; ?></td>
		                ...
		                <td class="text-center"><a id="removerPadronSV" class = "btn btn-danger enc" href="#" data-toggle="modal" data-target="#modal_noprocede" onClick="modal(<?php echo $servicio->Id_Servicio_SV; ?>);" >Quitar <span class="icon-remove"></span> </a></td>
		          		</tr>
		          	<?php } ?>
		        	</tbody>
		      	</table>
...
<div id="modal_noprocede" class="modal hide fade" tabindex="-1" aria-labelledby="myModalLabel">
    ...
    <form method="post" id="datos" action="<?php echo site_url('c_programasalimentarios/removerPadronSV');?>">
...
<script type="text/javascript">
  ...
  function guardar(e)
  {
    ...
    $.ajax({
      type : 'POST',
      url : "<?php echo site_url().'/c_programasalimentarios/removerPadronSV/' ?>"+Id_Servicio_SV,
      data :$("#datos").serialize(),
      dataType: 'json',
      success : function(data) {
        console.log(data);
        window.location = "<?php echo site_url().'/c_programasalimentarios/padronSV/';?>";
      },
