	...
	<div class="span12">      		
		<div class="widget ">
			<div class="widget-header">
				...
				<h3>Presidencia <small> Casos para seguimiento</small></h3>
			</div> <!-- /widget-header -->
		            ...
		            <tbody>
		            	<?php foreach ($servicios as $servicio) {
		              		if ($servicio->Id_Estatus != 5) { ?>
				                ...
				                <td class="text-center"><a <?php if ($servicio->Id_Estatus == 6) {echo 'class = "btn btn-warning enc"';} else { echo 'class = "btn btn-danger enc"';}?> href="<?php echo site_url().'/c_presidencia/canalizar/'.$servicio->Id_Programa_DIF.'/'.$servicio->Id_Persona.'/'.$servicio->Id; ?>">Seleccionar  <span class="icon-ok-sign"></span> </a></td>
		              			</tr>
		              		<?php }
		            	} ?>
		            </tbody>
